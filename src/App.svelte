...
<Header bgcolor="#206095" bgfixed={true} theme="dark" center={false} short={true}>
	<h1>Sustaining our Cities with Trees</h1>
	<p class="text-big" style="margin-top: 5px">
		Often overlooked, trees are a important part of out urban centres. They serve as effective air purifiers
		and are important to mitigate the climatic conditions in and around urban areas.
	</p>
	<p>
...
<Filler theme="lightblue" short={true} wide={true} center={false}>
	<p class="text-big" style="text-align:justify">
		Environment now is one of the most important topics for countries across the globe. But for most of them, time is running out. There also have been success stories with a few cities to harvest the destruction and regenerate a healthier life. The gains of tree plantations have reaped gains in the long run. But how do trees help us? How can they play a part in rejuvenating the economy in geography? Planting more trees would mean having cleaner air, cleaner water and lower carbon use. Apart from maintaining a cleaner environment how do they help us?
	</p>
</Filler>
